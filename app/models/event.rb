class Event
  ...
  # FIXED: Remove :through association and replace with custom method
  # has_many :attendees, through: :registrations, class_name: 'User' # REMOVE THIS LINE
  ...
  # FIXED: Custom method to get attendees
  def attendees
    User.in(id: registrations.pluck(:user_id))
  end
