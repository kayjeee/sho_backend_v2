  ...
  module V1
    class OnboardingStatusesController < ApplicationController
      ...
      def update
        ...
        @target_user.set(onboarding_status: (@target_user.onboarding_status || {}).merge(updates_with_context))
      ...
      def skip_step
        ...
        current_status = @target_user.onboarding_status || {}
        skipped = (current_status["skipped_steps"] || [])
        skipped << { step: step_name, reason: reason, skipped_at: Time.current.iso8601 }

        @target_user.set(onboarding_status: current_status.merge("skipped_steps" => skipped))
