...
# Optimized Rails 8 + Mongoid Dockerfile for Fly.io and local development
# Build locally: docker build -t sho_backend_v2 .
# Run locally: docker run -p 8080:8080 -e RAILS_MASTER_KEY=<key> -e MONGODB_URI=<uri> sho_backend_v2
